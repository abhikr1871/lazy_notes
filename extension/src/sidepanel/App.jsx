...
import {
    ...
    Type, AlignLeft, Camera, FileText, Mic, Clock, Film, Moon, Sun
} from 'lucide-react';
...
function App() {
    ...
    const handleLogoClick = () => {
        setIsAnimating(true);
        setTimeout(() => setIsAnimating(false), 1500); // 1.5s animation
    };
                ...
                <div className="flex items-center space-x-3.5 group cursor-pointer" onClick={handleLogoClick}>
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-1">
                            <p className="text-[10px] text-slate-400 font-bold tracking-[0.2em] uppercase pl-0.5">AI Companion</p>
